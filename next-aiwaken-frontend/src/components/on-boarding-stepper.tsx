...
const steps = [
  {
    ...
    description:
      "I'm your AI assistant! I'll guide you through our platform's key features.",
    robotMessage:
      "Hello there! 👋 I'm excited to show you around our platform. Let's get started with a quick tour!",
  },
  {
  ...
  },
  {
    ...
    description:
      "Deploy your projects with a single click to our global network.",
    robotMessage:
...
export function OnboardingStepper() {
  ...
  if (isComplete) {
    return (
      <Card className="w-full max-w-3xl rounded-xl glow-card border border-[#9F8DFC] p-6 shadow-xl md:p-8 ">
        <motion.div
        ...
        >
          <div className="flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-muted-foreground">
              You&apos;ve completed the onboarding. Start exploring all the
              features now.
            </p>
